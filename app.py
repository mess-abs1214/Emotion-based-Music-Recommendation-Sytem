...
df = pd.read_csv(r"C:\Users\meisu\Downloads\Emotion-based-music-recommendation-system-main\muse_v3.csv")
...
model.load_weights(r"C:\Users\meisu\Downloads\Emotion-based-music-recommendation-system-main\model.h5")
...
face = cv2.CascadeClassifier(r"C:\Users\meisu\Downloads\Emotion-based-music-recommendation-system-main\haarcascade_frontalface_default.xml")
if face.empty():
    ...
    if st.button('SCAN EMOTION(Click here)'):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:               
                ...
                frame_resized = cv2.resize(frame, (1000, 700), interpolation=cv2.INTER_CUBIC)
